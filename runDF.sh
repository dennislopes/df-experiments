...
if [[ $3 == "classRuntimeTrue" ]]
then
     export PARAMETER="-Dbadua.experimental.ModifiedSystemClassRuntime=true"
fi
if [[ $3 == "exceptionHandlerFalse" ]]
then
     export PARAMETER="-Dbadua.experimental.exception_handler=false"
fi

echo -e "\n${YELLOW} Parametro Experimental $PARAMETER ${NOCOLOR}"
...
#java -verbose:class -javaagent:$BADUA_AGENT \
